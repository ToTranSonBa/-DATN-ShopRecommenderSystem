...
namespace ShopRe.Data.Migrations
{
    ...
    [Migration("20240702072702_change_orderitem_cartitem")]
    partial class change_orderitem_cartitem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "54ae27ad-d861-4653-99d3-0325af30d915",
                            ConcurrencyStamp = "5875a042-d4a7-4961-9213-0a3ce6fb267f",
                            Name = "Seller",
                            NormalizedName = "SELLER"
                        },
                        new
                        {
                            Id = "487c9399-2cc1-48ed-ab90-880c55d82a82",
                            ConcurrencyStamp = "6cd94868-d81b-4cbd-a4a5-bda9e6a19707",
                            Name = "Administrator",
                            NormalizedName = "ADMINISTRATOR"
                        },
                        new
                        {
                            Id = "29efe628-edfe-4015-8fe8-ecc66b24e360",
                            ConcurrencyStamp = "75882495-4e0c-446f-8708-d6c0ce1f29f3",
                            Name = "Customer",
                            NormalizedName = "CUSTOMER"
                        },
                        new
                        {
                            Id = "32e5148b-57f6-4cb2-9362-27985ce520ac",
                            ConcurrencyStamp = "972e3336-1c11-4d1b-9635-b3fb23202b6f",
                            Name = "Shipper",
            ...
            modelBuilder.Entity("ShopRe.Model.Models.CartItem", b =>
                {
                    ...
                    b.Property<int?>("OptionValuesId2")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopRe.Model.Models.CommentImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("DetailCommentID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopRe.Model.Models.ProductChild", b =>
                {
                    ...
                    b.Property<int?>("OptionValuesID1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopRe.Model.Models.SelCates", b =>
                {
                    ...
                    b.Property<int>("CateLv0")
                        .HasColumnType("int");

                    b.Property<int>("CateLv1")
                        .HasColumnType("int");

                    b.Property<int>("CateLv2")
                        .HasColumnType("int");

                    b.Property<int>("CateLv3")
                        .HasColumnType("int");

                    b.Property<int>("CateLv4")
                        .HasColumnType("int");

                    b.Property<int>("CateLv5")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopRe.Model.Models.Account", b =>
                {
                    b.HasOne("ShopRe.Model.Models.ApplicationUser", "User")
                        .WithOne("Account")
                        .HasForeignKey("ShopRe.Model.Models.Account", "UserID")
                        .HasPrincipalKey("ShopRe.Model.Models.ApplicationUser", "TrainCode");
            ...
            modelBuilder.Entity("ShopRe.Model.Models.CartItem", b =>
                {
                    ...
                    b.HasOne("ShopRe.Model.Models.ProductOptionValues", "optionValues2")
                        .WithMany()
                        .HasForeignKey("OptionValuesId2");
                    ...
                    b.Navigation("optionValues2");
                });

            modelBuilder.Entity("ShopRe.Model.Models.CommentImages", b =>
                {
                    b.HasOne("ShopRe.Model.Models.DetailComment", "DetailComment")
                        .WithMany("Images")
                        .HasForeignKey("DetailCommentID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DetailComment");
                });
