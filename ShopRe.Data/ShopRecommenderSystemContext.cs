...
{
    public class ShopRecommenderSystemContext:DbContext
    {
        public ShopRecommenderSystemContext(DbContextOptions<ShopRecommenderSystemContext> options):base (options) { }
