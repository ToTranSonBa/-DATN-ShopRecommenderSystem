                        ...
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-6 ">
                                <p class="text-sm text-gray-800">
                                    ShopLY là trang thương mại điện tử cho phép người mua và người bán tương tác và trao
                                    đổi dễ dàng thông tin về sản phẩm và chương trình khuyến mãi của shop.
                                </p>
                                <p class="mt-4 text-sm text-gray-800">
                                    Việc mua bán trên ShopLY trở nên nhanh chóng và đơn giản hơn. Bạn có thể trò chuyện
                        ...
                        <div>
                            <div>
                                ...
                                <div class="flex items-center mt-2 space-x-3">
                                    <a
                                        href="/"
                                        class=" transition-colors duration-300 hover:text-deep-purple-accent-400"
                                    >
