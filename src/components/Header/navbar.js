...
const NavbarCustom = ({
  ...
  return (
    <div
      className={`hidden md:block inset-x-0 top-24 md:absolute md:z-11 ${className_dropshadow}`}
    >
                ...
                <div className="w-full h-auto col-span-1 col-start-2 row-span-1 row-start-1 overflow-y-scroll border-r-2">
                  <ul className="flex-row">
                    {AllCategories_Data[hoveredIndex] &&
                      ...
                      AllCategories_Data[hoveredIndex].submenu.map(
            ...
            <div className="flex items-center justify-around w-full h-auto lg:py-12">
              <div className="flex-row mx-auto">
                <span className="text-orange-600 lg:text-3xl lg:leading-10">
                  T
                  <span className="text-black lg:text-2xl">rade Assurance</span>
                </span>
                ...
                (buyer, index) =>
                  ...
                  buyer.submenu && (
                    <ul className="flex-row" key={index}>
                      <li className="font-semibold lg:leading-10">
                        {buyer.title}
                      </li>
                      {buyer.submenu.map((subbuyer, subindex) => (
                        <li
                          className="font-light lg:leading-10 hover:underline"
                          key={subindex}
                        >
