            ...
            <ul className="flex items-center -mx-[6px]">
                <li className="px-[6px]">
                    <a
                        ...
                        className={`w-9 h-9 flex items-center justify-center rounded-md border border-[#EDEFF1] text-[#838995] text-base hover:border-blue-700 ${
                ...
                {pageNumbers.map((number) => (
                    <li key={number - 1} className="px-[6px]">
                        <a
                            ...
                            className={`w-9 h-9 flex items-center justify-center rounded-md border border-[#EDEFF1] text-[#838995] text-base hover:border-blue-700 ${
                                number === currentPage ? 'bg-blue-700 border-blue-700 text-white' : ''
                            }`}
                        >
                            {number + 1}
                        </a>
