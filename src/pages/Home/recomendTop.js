...
const RecommendTop = () => {
    ...
    const prevSlide = () => {
        setCurrentIndex((prevIndex) => (prevIndex === 0 ? TopRank.length - 1 : prevIndex - 1));
    };

    const nextSlide = () => {
        setCurrentIndex((prevIndex) => (prevIndex === TopRank.length - 1 ? 0 : prevIndex + 1));
    };
