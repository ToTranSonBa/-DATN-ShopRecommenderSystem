        ...
        <div class="lg:pt-36 font-sans bg-background grid justify-center pt-20">
                    ...
                    <div class="lg:col-span-5">
                        ...
                        <div class="flex flex-wrap gap-4 mt-4">
                            ...
                            <p class="text-gray-400 text-xl">
                                <strike>$16</strike> <span class="text-sm ml-1">Tax included</span>
                            </p>
                        </div>
                        ...
                        <form className="flex items-center max-w-full gap-5 mt-8">
                            <label
                                ...
                                className="block mr-2 text-xs font-medium text-gray-500 dark:text-white"
                            >
                                Số Lượng:
                            </label>
            ...
            <div class="p-6 mt-8 bg-white">
                ...
                <ul class="space-y-3 list-disc mt-4 pl-4 text-sm text-gray-700">
                    ...
                    <li>
                        Easy to prepare. It can be brewed using various methods, from drip machines to manual
                        pour-overs.
                    </li>
                    <li>
                        Available in various sizes, from a standard espresso shot to a large Americano, catering to
                        different preferences.
                    </li>
                    <li>
                        You can customize your coffee by adding cream, sugar, or flavorings to suit your taste
                        preferences.
                    </li>
                </ul>
            </div>
