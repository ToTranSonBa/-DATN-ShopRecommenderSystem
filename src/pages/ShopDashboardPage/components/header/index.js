            ...
            <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
                    ...
                    <button class="z-50 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-strokedark dark:bg-boxdark lg:hidden">
                        <span class="relative block h-6 w-6 cursor-pointer">
                            <span class="du-block absolute right-0 h-full w-full">
                                <span class="relative left-0 top-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-[0] duration-200 ease-in-out dark:bg-white"></span>
                                <span class="relative left-0 top-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-150 duration-200 ease-in-out dark:bg-white"></span>
                                <span class="relative left-0 top-0 my-1 block h-0.5 w-0 rounded-sm bg-black delay-200 duration-200 ease-in-out dark:bg-white"></span>
                            </span>
                            <span class="du-block absolute right-0 h-full w-full rotate-45">
                                <span class="absolute left-2.5 top-0 block h-full w-0.5 rounded-sm bg-black delay-300 duration-200 ease-in-out dark:bg-white"></span>
                                <span class="delay-400 absolute left-0 top-2.5 block h-0.5 w-full rounded-sm bg-black duration-200 ease-in-out dark:bg-white"></span>
                            </span>
                        </span>
                    </button>
                ...
                <div class="flex items-center gap-3 2xsm:gap-7">
                    <ul class="flex items-center gap-2 2xsm:gap-4">
                                        ...
                                        {notification.map((notification, index) => (
                                            <li key={index}>
                                                ...
                                                >
                                                    ...
                                                    <p class="text-xs">
                                                        {format(new Date(notification.time), 'dd MMMM, yyyy', {
                                                            locale: vi,
                                                        })}
                                                    </p>
                                                </a>
                        ...
                        <li className="relative">
                            <a
                                ...
                                onClick={(e) => {
                                    e.preventDefault();
                                    setDropdownMessageOpen(!dropdownMessageOpen);
                                }}
                            >
                            ...
                            {dropdownMessageOpen && (
                                ...
                                >
                                    <div className="px-4 py-3">
                                        <h5 className="font-normal text-md">Tin nhắn</h5>
                                    </div>
                    ...
                    <div class="relative">
                        ...
                        {dropdownUserOpen && (
                            <div
                                onClickOutside={() => setDropdownUserOpen(false)}
                                class=" absolute right-0 mt-4 flex w-72 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark"
                            >
...
export default DoashboardHeader;
