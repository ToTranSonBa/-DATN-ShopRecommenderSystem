...
const DoashboardSideBar = ({ useroption, setDropdownDashboardOpen }) => {
    const [dropdownDoashboardOpen, setDropdownDoashboardOpen] = useState(false);
    const [dropdownFormOpen, setDropdownFormOpen] = useState(false);
    const [dropdownTableOpen, setDropdownTableOpen] = useState(false);
    const [dropdownUIElementOpen, setDropdownUIElementOpen] = useState(false);
        ...
        <aside class="bg-sky-300/20 absolute left-0 top-0 z-9999 flex h-screen w-60 flex-col overflow-y-hidden  duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0">
            <div class="flex items-center justify-between gap-2 px-6 pt-5 lg:pt-7">
                <a className="items-center hidden md:flex md:gap-1 lg:gap-2">
                    ...
                    <span className="font-semibold lg:text-2xl text-primary">ShopLY</span>
                </a>
                ...
                <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
                    <div>
                        <ul class="mb-6 flex flex-col gap-1.5">
                            <li>
                                <a
                                    class="group relative flex items-center gap-2 rounded-sm px-4 py-2 font-medium text-body dark1 duration-300 ease-in-out hover:bg-gray dark dark:hover:bg-meta-4"
                                    href="#"
                                    onClick={(e) => {
                                        e.preventDefault();
                                        setDropdownDoashboardOpen(!dropdownDoashboardOpen);
                                    }}
                                >
                                    <svg
                                        class="fill-current"
                            ...
                            {dropdownDoashboardOpen && (
                                <div class=" translate transform overflow-hidden">
                                    <ul class="mb-4 mt-4 flex flex-col gap-2.5 pl-6">
                                        <li
                            ...
                            {/* <li className="cursor-pointer">
                                <a
                                    ...
                                    onClick={(e) => {
                                        e.preventDefault();
                                        setDropdownFormOpen(!dropdownFormOpen);
                                    }}
                                >
                                    <svg
                                        class="fill-current"
                            ...
                            <li className="cursor-pointer">
                                <a
                                    ...
                                    onClick={(e) => {
                                        e.preventDefault();
                                        setDropdownTableOpen(!dropdownTableOpen);
                                    }}
                                >
                                    <svg
                                        class="fill-current"
...
export default DoashboardSideBar;
