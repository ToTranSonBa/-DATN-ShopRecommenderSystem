        ...
        <aside class="bg-primary/10 absolute left-0 top-0 z-9999 flex h-screen w-60 flex-col overflow-y-hidden  duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0">
            ...
            <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
                <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6">
                    ...
                    {/* <div>
                        <h3 class="mb-4 ml-4 text-sm font-medium text-bodydark2">KHÁC</h3>
                        ...
                        <ul class="mb-6 flex flex-col gap-1.5">
                            ...
                            <li>
                                <a
                                    ...
                                    onClick={(e) => {
                                        e.preventDefault();
                                        setDropdownUIElementOpen(!dropdownUIElementOpen);
                                    }}
                                >
                                    <svg
                                        class="fill-current"
                            ...
                            <li>
                                <a
                                    ...
                                    onClick={(e) => {
                                        e.preventDefault();
                                        setDropdownAuthOpen(!dropdownAuthOpen);
                                    }}
                                >
                                    <svg
                                        class="fill-current"
