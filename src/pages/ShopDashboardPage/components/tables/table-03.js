                ...
                <table class="w-full table-auto">
                    <thead>
                        <tr class="bg-gray-2 text-left dark:bg-meta-4">
                            ...
                            <th class="min-w-[150px] px-4 py-4 font-medium text-black dark:text-white">Invoice date</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                <h5 class="font-medium text-black dark:text-white">Standard Package</h5>
                        ...
                        <tr>
                            <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                <h5 class="font-medium text-black dark:text-white">Business Package</h5>
