                                        ...
                                        {!inDoashboard && (
                                            <>
                                                <td class="px-6 py-4">
                                                    ...
                                                    {inDoashboard && (
                                                        <div className="h-20">{product.product.Category}</div>
                                                    )}
                                                </td>
                                                {/* <td class="px-6 py-4">
                                                ...
                                                <td class="px-6 py-4">
                                                    <div>
                                                        <div
                                                            ...
                                                            class="block font-medium hover:cursor-pointer w-[80px] bg-green-600/25  lg:px-3 lg:py-1 mx-auto text-center rounded-sm lg:my-2 text-green-700 dark:text-blue-500 hover:underline"
                                                        >
                                                            Chi tiết
                                                        </div>
                                                        <div
                                                            onClick={() => openEditProductForm(product)}
                                                            class="block font-medium hover:cursor-pointer w-[80px] bg-blue-600/25  lg:px-3 lg:py-1 mx-auto text-center rounded-sm lg:my-2 text-blue-600 dark:text-blue-500 hover:underline"
                                                        >
                                                            Sửa
                                                        </div>
