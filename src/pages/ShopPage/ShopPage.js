...
const ShopPage = () => {
    ...
    const [type, setType] = useState('Máy tính Casio');
    ...
    const fetchProducts = useCallback(async () => {
        try {
            const response = await axios.get('https://localhost:7016/api/Products', {
                params: {
    ...
    return (
        <div className="shop-page bg-background pt-16">
            {/* breadcrumb */}
            <div className="product-content-header w-3/4 m-auto py-4">
                            <div className="flex place-items-start">
                                <nav className="text-sm sm:text-base">
                                    ...
                                    <li className="flex items-center">
                                        <a href="#a" className="text-gray-600 hover:text-blue-500 transition-colors duration-300">Danh sách sản phẩm</a>
                                        <span className="mx-2">/</span>
                                    </li>
                                    <li className="flex items-center">
                                        <span className="text-gray-800">Laptop - Máy vi tính - Linh kiện</span>
                                    </li>
                                    </ol>
                                </nav>
                            </div>
