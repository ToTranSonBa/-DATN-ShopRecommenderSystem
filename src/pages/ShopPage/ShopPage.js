...
const data = {
    ...
    "ShortDescription": "Hãy khám phá thế giới cùng cuốn bản đồ khổng lồ đầu tiên ở Việt Nam! Sách gồm 52 tấm bản đồ minh họa sinh động các đặc điểm địa lý và biên giới chính trị, giới thiệu những địa điểm nổi tiếng, những nét văn hóa đặc sắc...",
    "Image": [
        {
...
const ShopPage = () => {
    ...
    const fetchProducts = useCallback(async () => {
        try {
            const response = await axios.get('https://localhost:7016/api/Products?PageNumber=1&PageSize=1000&keyWord=s%C3%A1ch');
            console.log(response);
    ...
    return (
        <div className="shop-page bg-background pt-16">
            {/* layout 2 cột */}
            <div className="flex md:flex-row w-3/4 m-auto">
                            ...
                            <ul className="space-y-2 text-sm" aria-labelledby="dropdownDefault">
                                {categories.map((category) => (
                                    <li key={category.category.ID_NK} className="flex items-center">
                                        ...
                                        <label className="ml-2 py-1 text-sm text-gray-900 dark:text-gray-100">
                ...
                <div className="flex-1 md:flex-none md:w-4/5 p-4">
                    ...
                    <div className="product-content">
                            ...
                            <div className="flex place-items-start">
                                <nav className="text-sm sm:text-base">
                                    ...
                                    <li className="flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512" className="cursor-pointer hover:fill-blue-500 transition-colors duration-300" fill="#4b5563"><path d="M575.8 255.5c0 18-15 32.1-32 32.1h-32l.7 160.2c0 2.7-.2 5.4-.5 8.1V472c0 22.1-17.9 40-40 40H456c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1H416 392c-22.1 0-40-17.9-40-40V448 384c0-17.7-14.3-32-32-32H256c-17.7 0-32 14.3-32 32v64 24c0 22.1-17.9 40-40 40H160 128.1c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2H104c-22.1 0-40-17.9-40-40V360c0-.9 0-1.9 .1-2.8V287.6H32c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z"/></svg><span className="mx-2">/</span>
                                    </li>
                                    <li className="flex items-center">
                                        <a href="#a" className="text-gray-600 hover:text-blue-500 transition-colors duration-300">Tools</a>
                        ...
                        {/* danh sách sản phẩm */}
                        <div className="bg-background flex items-center justify-center mt-8">
                                            ...
                                            <div className="px-5 pb-5 h-auto">
                                                ...
                                                <div className="flex items-center mt-2.5 mb-5">
                                                    ...
                                                    <span className="bg-blue-100 text-blue-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded ml-3">
                                                        {typeof product.RatingAverage === "number" ? product.ratingAverage : "N/A"}
                                                    </span>
                                                </div>
                                                <div className="flex items-center justify-between align-bottom">
                                                    {
                                                        (product.originalPrice !== product.price) ? (
                                                            <div>
                                                                <p className="text-xs text-gray-300 line-through">{formatNumber(product.originalPrice)}₫</p>
                                                                <span className="text-xl font-semibold text-gray-900">{formatNumber(product.price)}₫</span>
                                                            </div>
                                                        ) : (
                                                            <span className="text-xl font-semibold text-gray-900">{formatNumber(product.originalPrice)}₫</span>
                                                        )
                                                    }
                                                    <a href="#a"
                                                        className="border-blue-700 text-blue-700 border bg-white hover:text-white hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm p-2 text-center">Mua ngay</a>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
