...
const UserPage = () => {
    ...
    return (
        <div className="lg:pt-36 bg-background w-full flex flex-col gap-5 px-3 md:px-16 lg:px-28 md:flex-row text-[#161931]">
            <aside className="hidden py-4 md:w-1/3 lg:w-1/4 md:block">
                <div className="sticky flex flex-col gap-2 p-4 text-sm border-r border-indigo-100">
                    ...
                    <a
                        href="#"
                        className="flex items-center px-3 py-2.5 font-semibold hover:text-indigo-900 hover:border hover:rounded-full"
                        onClick={() => handleOptionClick('PRO Account')}
                    >
                        PRO Account
                    </a>
                </div>
            ...
            {selectedOption && (
                <main className="w-full min-h-screen py-1 bg-white md:w-2/3 lg:w-3/4">
                    <div className="grid justify-center p-2 md:p-4">
                        ...
                        {selectedOption === 'Account Settings' && <div className=""></div>}
                    </div>
                </main>
            )}
        </div>
